...
open class BottomPopupNavigationController: EZNavigationController, BottomPopupAttributesDelegate {
    ...
    public func handlePanGesture(gesture: UIPanGestureRecognizer) {
        transitionHandler?.handlePanGesture(gesture)
    }
    
    public func cancelGesture() {
        transitionHandler?.cancelGesture()
    }
